...
<section className="py-8 px-4  dark:bg-gray-800" id="work-experience">

<h2 className="text-2xl font-bold text-white dark:text-white mb-4">
  Professional Experiences :-
</h2>
<ul className="space-y-4 -mt-2">
  <li className="bg-gray-200 rounded-lg p-4 hover:bg-green-300 transition duration-300">
    <div className="flex items-center">
      <div className="flex-grow h5">
        <h3 className="text-xl font-bold text-gray-900 dark:text-white">
          Frontend Developer- (React JS)
        </h3>
        <h4 className="text font-bold text-gray-900 dark:text-white">
        Tokn Music
        </h4>
        ...
        <li>Built reusable components and front-end libraries.</li>
        <li>Optimized components for maximum performance across a wide range of web-capable devices and browsers.</li>
  ...
  <li className="bg-gray-200 rounded-lg p-4 hover:bg-green-300 transition duration-300">
    <div className="flex items-center">
      <div className="flex-grow h5">
        ...
        <h4 className="text- font-bold text-gray-900 dark:text-white">
        Ramakrishna Mission Vivekananda Cultural Centre
        </h4>
        <div className="text-gray-600 dark:text-gray-400 text-sm">
          Internship (On-site)
        </div>
